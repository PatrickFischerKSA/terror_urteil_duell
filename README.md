...
Eigenständiges Unterrichtsprojekt zur Schlussabstimmung in Ferdinand von Schirachs *Terror*.
...
### 2. Argumente-Pingpong
- Zwei Personen spielen sieben Runden gegeneinander.
- Eine Person eröffnet mit einem Argument, die andere reagiert.
- Ein lokaler KI-Schiedsrichter bewertet:
  - klare These
  - Begründung
  - Beleg
  - Schlussform
  - Reaktion auf das Gegenargument
  - mögliche Fehlschlüsse
- Die unterlegene Seite muss die nächste Runde eröffnen.
- Danach kann direkt eine Revanche gestartet werden.
